...
use crate::types::{
    Action, AgentStatus, Boundary, BoundaryValidated, GasPrice, Interval, Task, Transform,
};
...
impl TaskRequestBuilder {
    ...
    pub fn build(&self) -> Result<TaskRequest, CoreError> {
        ...
        Ok(TaskRequest {
            ...
            cw20_coin: self.cw20_coins.clone(),
        })
    }
}
